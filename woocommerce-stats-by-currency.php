...
// Admin Notice
add_action( 'admin_init', 'wsbc_required_plugins' );

function wsbc_required_plugins() {
    if ( is_admin() && current_user_can( 'activate_plugins' ) &&  !is_plugin_active( 'woocommerce/woocommerce.php' )  ) {
        add_action( 'admin_notices', 'wsbc_notice' );
...
function wsbc_notice(){
    ?><div class="error"><p>Sorry, This plugin require <strong>WooCommerce</strong> and <strong>Price Based on Country for WooCommerce</strong> plugins to work.</p></div><?php
}
